...
/**
 * movie roles info service interface
 *
 * @author Cherlas
...
public interface RoleService {
     ...
     * @return {@link Mono} emitting the saved role.
     ...
     * @return {@link Flux} emitting the saved roles.
     ...
     *
     * @return {@link Flux} emitting all roles.
     */
    Flux<Role> findAll();
     ...
     * @return {@link Flux} emitting the found roles. The size can be equal or less than the number of given
     * {@literal ids}.
     ...
     *
     * @return {@link Mono} emitting the number of roles.
     */
    Mono<Long> count();
     ...
     * @param role must not be {@literal null}.
     * @return {@link Mono} signaling when operation has completed.
     * @throws IllegalArgumentException in case the given role is {@literal null}.
     */
